/*
  ...
  1. New Tables
    - `resources`
      ...
      - `type` (text, either 'document' or 'photo')
      - `name` (text)
    ...
    - `shared_resources` (junction table)
  ...
  2. Security
    ...
    - Add policies for authenticated users to manage resources and shares
    - Add policies for share access

  3. Indexes
    - Project ID indexes for efficient lookups
    - Created at and expires at indexes for sorting
*/
